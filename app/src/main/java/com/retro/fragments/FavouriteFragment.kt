...
import com.retro.R
import com.retro.adapters.FavouriteContentAdapter
import com.retro.database.RetroDatabase
import com.retro.fragments.FavouriteFragment.Statified.meediaPlayer
...
class FavouriteFragment : Fragment() {
    ...
    var favouriteDatabase: RetroDatabase? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        favouriteDatabase = RetroDatabase(activity)
    ...
    fun display_favorites_by_searching() {
        if (favouriteDatabase?.checkSize() as Int > 0) {
            ...
            _getSongs = (favouriteDatabase as RetroDatabase).queryDBforList()
